function CerrarSesion(){
                ...
                '<div class="text-center" >'+
                    ...
                    '<div style="padding-top:30px">'+
                        '<button  disabled style="box-sizing: border-box;  border-color: #b44593;border: 1px solid rgba(0, 0, 0, 0.2);'+
                            'border-radius: 25px;font-style: normal;font-weight: 400;font-size: 20px;line-height: 24px;text-align: center;color: #525252;padding: 15px;">Gestionar tu cuenta ISAA'+
                        '</button>'+
                    '</div>'+
                '</div>'+
                '<div>'+
    ...
    async function confirm(){
        Swal.fire(window.location = "Login.html")      
    }
  async function pawd (){
